...
const CreatePost = () => {
  ...
  return (
    <div className='min-h-screen bg-gradinet-to-b from-slate-50 to-white'>
      <div className="max-w-6xl mx-auto p-6">
        ...
        {/* Form */}
        <div className="max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-6">
          {/* Header */}
            ...
            images.length > 0 && <div className='flex flex-wrap gap-2 mt-4'>
              {
                images.map((image,i)=>(
                  <div key={i} className='relative group'>
                    ...
                    <div onClick={()=>setImages(image.filter((_,index)=>index !== i))} className='absolute hidden group-hover:flex justify-center items-center top-0 left-0 bottom-0 right-0 bg-black/40 rounded-md cursor-pointer'>
