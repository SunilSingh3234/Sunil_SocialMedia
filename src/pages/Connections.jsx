...
import {
  ...
  dummyFollowersData as followers,  dummyFollowingData as following,
    ...
    <div className='min-h-screen bg-slate-50'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div className='mb-8'>
          ...
          <p className='text-slate-600'>Mangae your network and discover new connections</p>
        </div>
            ...
            <div key={user._id} className='w-full max-w-88 flex gap-5 p-6 bg-white shadow rounded-md '>
              ...
              <div className='flex-1'>
                ...
                <div className="flex gap-2 mt-4 max-sm:flex-col">
                  {
                    <button onClick={()=>navigate(`/profile/${user._id}`)} className='w-full p-2 text-sm rounded bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transiton text-white cursor-pointer'>
                      View Profile
                    </button>
                  }
                  {
