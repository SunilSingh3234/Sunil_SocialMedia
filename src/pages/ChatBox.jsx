    ...
    <div className='flex flex-col h-screen'>
      ...
      <div className="px-4">
        <div className="flex items-center gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto border border-gray-200 shadow mb-5 rounded-full">
          <input type="text" className='flex-1 text-slate-700 outline-none' placeholder='Type a message...' onKeyDown={e=>e.key === 'Enter' && sendMessage()} onChange={(e)=>setText(e.target.value)} value={text}/>
          <label htmlFor="image">
            {
