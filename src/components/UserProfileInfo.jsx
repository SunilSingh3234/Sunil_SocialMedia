    ...
    <div className='relative py-4 px-6 md:px-8 bg-white'>
        <div className="flex flex-col md:flex-row items-start gap-6">
            <div className="w-32 h-32 border-4 border-white shadow-lg absolute -top-16 rounded-full">
                <img src={user.profile_picture} className='z-2 rounded-full absolute' alt="" />
            </div>
            ...
            <div className="w-full pt-16 md:pt-0 md:pl-36">
                <div className="flex flex-col md:flex-row items-start justify-between">
                    ...
                    */}
                    {
                        !profileId && <button onClick={()=>setShowEdit(true)} className='flex cursor-pointer items-center gap-2 border border-gray-300 hover:bg-gray-50 py-2 px-4 rounded-lg font-medium tranisiton-colors mt-4 md:mt-0'>
                ...
                <div className='flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-gray-500 mt-4'>
                    ...
                    <span className='flex items-center gap-1.5'>
                        ...
                        Joinded <span className='font-medium'>{moment(user.createdAt).fromNow()}</span>
                    </span>
                </div>
